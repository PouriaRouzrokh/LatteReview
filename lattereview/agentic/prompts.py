...
def _build_effort_guidance(effort: str, max_iterations: int) -> str:
    ...
    if effort == "low":
        ...
        body = (
            ...
            "4. If you learn something generalizable, save it as a detailed memory.\n"
            "   Maintain balanced perspectives — don't only accumulate one type of\n"
            "   conclusion. Make memories specific enough to be useful on future items.\n"
        ...
        body = (
            ...
            "3. If you discover a generalizable insight, save it as a detailed memory.\n"
            "   Maintain balanced perspectives — don't only accumulate one type of conclusion.\n"
